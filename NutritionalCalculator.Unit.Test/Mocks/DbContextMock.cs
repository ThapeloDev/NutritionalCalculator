...
{
    class DbContextMock : DbContext, INutritionalCalculatorContext
    {
        private string DataBase { get; set; }
        public DbContextMock(string dataBase)
        {
            DataBase = dataBase;
        }

        public DbContextMock(DbContextOptions<DbContextMock> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ModelTest> ModelTest { get; set; }
        public DbSet<FoodsInCategories> FoodsInCategories { get; set; }
        public DbSet<FoodsEditedByUsers> FoodsEditedByUsers { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FattyAcidsAndCholesterol>(entity =>
            {
                ...
                entity.ToTable("FatSolubleVitamins", "Api");
                ...
                entity.HasOne(d => d.IdFoodNavigation)
                    ...
                    .HasConstraintName("FK_FatSolubleVitamins__Foods");
            });
            ...
            modelBuilder.Entity<Vitamins>(entity =>
            {
                ...
                entity.ToTable("WaterSolubleVitamins", "Api");
                ...
                entity.HasOne(d => d.IdFoodNavigation)
                    ...
                    .HasConstraintName("FK_WaterSolubleVitamins__Foods");
            });
        }
    }
}

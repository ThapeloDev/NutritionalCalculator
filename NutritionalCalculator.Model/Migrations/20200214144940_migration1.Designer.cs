...
namespace NutritionalCalculator.Model.Migrations
{
    ...
    [Migration("20200214144940_migration1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FatSolubleVitamins", b =>
                {
                    b.Property<string>("IdFood")
                        .HasMaxLength(150);
                    ...
                    b.ToTable("FatSolubleVitamins","Api");
                });

            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FoodCategories", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FoodInCategories", b =>
                {
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FoodReferences", b =>
                {
                    b.Property<string>("IdFood")
                        .HasMaxLength(150);
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.WaterSolubleVitamins", b =>
                {
                    b.Property<string>("IdFood")
                        .HasMaxLength(150);
                    ...
                    b.ToTable("WaterSolubleVitamins","Api");
                });
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FatSolubleVitamins", b =>
                {
                    b.HasOne("NutritionalCalculator.Model.Entities.Db.Foods", "IdFoodNavigation")
                        .WithOne("FatSolubleVitamins")
                        .HasForeignKey("NutritionalCalculator.Model.Entities.Db.FatSolubleVitamins", "IdFood")
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.FoodInCategories", b =>
                {
                    b.HasOne("NutritionalCalculator.Model.Entities.Db.FoodCategories", "FoodCategory")
            ...
            modelBuilder.Entity("NutritionalCalculator.Model.Entities.Db.WaterSolubleVitamins", b =>
                {
                    b.HasOne("NutritionalCalculator.Model.Entities.Db.Foods", "IdFoodNavigation")
                        .WithOne("WaterSolubleVitamins")
                        .HasForeignKey("NutritionalCalculator.Model.Entities.Db.WaterSolubleVitamins", "IdFood")
